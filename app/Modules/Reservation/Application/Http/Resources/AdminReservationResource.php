...
/**
 * @OA\Schema(
 *     schema="AdminReservationResource",
 *     required={"id", "user_id", "asset_id", "date_from", "date_to", "total_price", "number_of_nights", "created_at", "updated_at"},
 *     @OA\Property(property="id", type="string", format="uuid", example="ae6fc2f0-0676-11ec-b4e8-07f02bffb055", nullable=false),
 *     @OA\Property(property="user_id", type="string", format="uuid", example="ae6fc2f0-0676-11ec-b4e8-07f02bffb055", nullable=false),
